...
['root'], ['adjective', 'argument', '1'], ['adjective', 'argument', '2'], ['adjective', 'modifier'], ['appositional', 'argument', '1'], ['appositional', 'argument', '2'], ['auxiliary', 'argument', '1'], ['auxiliary', 'argument', '2'], ['', 'auxiliary', 'modifier'], ['complement', 'argument', '1'], ['complement', 'argument', '2'], ['complement', 'modifier'], ['conjunct', 'argument', '1'], ['conjunct', 'argument', '2'], ['conjunct', 'argument', '3'], ['coordination', 'argument', '1'], ['coordination', 'argument', '2'], ['determiner', 'argument', '1'], ['argument', '2'], ['it', 'argument', '1'], ['argument', '2'], ['parenthetical', 'argument', '1'], ['parenthetical', 'argument', '2'], ['parenthetical', 'argument', '3'], ['none'], ['none', 'argument', '1'], ['none', 'argument', '2'], ['possessive', 'argument', '1'], ['possessive', 'argument', '2'], ['prepositional', 'argument', '1'], ['prepositional', 'argument', '2'], ['prepositional', 'argument', '3'], ['prepositional', 'modifier'], ['punctuation', 'argument', '1'], ['quote', 'argument', '1'], ['quote', 'argument', '2'], ['quote', 'argument', '3'], ['relative', 'argument', '1'], ['relative', 'argument', '2'], ['verb', 'argument', '1'], ['verb', 'argument', '2'], ['verb', 'argument', '3'], ['verb', 'argument', '4'], ['verb', 'modifier']]
...
'[root]', '[adj_ARG1]', '[adj_ARG2]', '[adj_MOD]', '[app_ARG1]', '[app_ARG2]', '[aux_ARG1]', '[aux_ARG2]', '[aux_MOD]', '[comp_ARG1]', '[comp_ARG2]', '[comp_MOD]', '[conj_ARG1]', '[conj_ARG2]', '[conj_ARG3]', '[coord_ARG1]', '[coord_ARG2]', '[det_ARG1]', '[dtv_ARG2]', '[it_ARG1]', '[lgs_ARG2]', '[lparen_ARG1]', '[lparen_ARG2]', '[lparen_ARG3]', '[none]', '[none_ARG1]', '[none_ARG2]', '[poss_ARG1]', '[poss_ARG2]', '[prep_ARG1]', '[prep_ARG2]', '[prep_ARG3]', '[prep_MOD]', '[punct_ARG1]', '[quote_ARG1]', '[quote_ARG2]', '[quote_ARG3]', '[relative_ARG1]', '[relative_ARG2]', '[verb_ARG1]', '[verb_ARG2]', '[verb_ARG3]', '[verb_ARG4]', '[verb_MOD]']
...
def metric(tokenizer, predictions, golds, best_metric, extra_labels=None):
    ...
    with open("sedp_sdp15_pas_output.txt", "w") as fw:
